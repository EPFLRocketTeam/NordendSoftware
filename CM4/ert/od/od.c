...
ALLOCATE_OD_ENTRY(ENG_TEMP_I2C, 27, engine_temp_data_t);
ALLOCATE_OD_ENTRY(ENG_PRESS_I2C_A, 28, engine_press_data_t);
ALLOCATE_OD_ENTRY(ENG_PRESS_I2C_B, 29, engine_press_data_t);
ALLOCATE_OD_ENTRY(ENG_PRESS_I2C_C,30, engine_press_data_t);
